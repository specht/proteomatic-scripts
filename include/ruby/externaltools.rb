...
class ExternalTools
	...
	def self.install(as_Package, ak_Description = nil, as_ResultFilePath = nil, ak_PackageDescription = nil)
		...
		ak_PackageDescription = YAML::load_file(File::join(@@ms_RootPath, "cli-tools-atlas/packages/ext.#{ls_Package}.yaml")) unless ak_PackageDescription
	...
	def self.binaryPath(as_Tool)
		lk_ToolDescription = YAML::load_file(File::join(@@ms_RootPath, "cli-tools-atlas/packages/ext.#{as_Tool}.yaml"))
		ls_Package = as_Tool.split('.').first
		lk_PackageDescription = YAML::load_file(File::join(@@ms_RootPath, "cli-tools-atlas/packages/ext.#{ls_Package}.yaml"))
	...
	def self.installed?(as_Package)
		lb_Ok = true
		lk_PackageDescription = YAML::load_file(File::join(@@ms_RootPath, "cli-tools-atlas/packages/#{as_Package}.yaml"))
		ls_Package = as_Package.sub('ext.', '')
		begin
