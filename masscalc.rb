...
class MassCalc < ProteomaticScript
    def run()
        lk_Masses = {'G' => 57.021464, 'A' => 71.037114, 'S' => 87.032029,
            'P' => 97.052764, 'V' => 99.068414, 'T' => 101.047679, 'C' => 103.009185,
            'L' => 113.084064, 'I' => 113.084064, 'N' => 114.042928, 'D' => 115.026944,
            'Q' => 128.058578, 'K' => 128.094963, 'E' => 129.042594, 'M' => 131.040485,
            'H' => 137.058912, 'F' => 147.068414, 'R' => 156.101111, 'Y' => 163.063329,
            'W' => 186.079313, 's' => 166.998359, 't' => 181.014011, 'y' => 243.029661,
            'm' => 147.035405, '$' => 0.0, 'X' => 0.0}
        ld_Water = 18.01057
        # UNSURE ABOUT THIS VALUE BUT OK WITH BIANCAS EXAMPLES, should be 1.0078250
        # 1.0078250 is monoisotopic mass of H2 divided by 2 --> wrong 
        # ld_Hydrogen = 1.0073250 --> don't know where this value is coming from
        # 1.0072764 = H - electron = Proton
        ld_Hydrogen = 1.0072764
